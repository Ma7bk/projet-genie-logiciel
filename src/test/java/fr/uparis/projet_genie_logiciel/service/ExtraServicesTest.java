...
class ExtraServicesTest {
    ...
    void testStudentServiceGetByClasseMultipleResults() {
        ...
        Student s2 = new Student("S2", "Paul", "Martin", "paul@u-paris.fr", "2A");
    ...
    void testQuizWithTrueFalseQuestionWrong() {
        ...
        Student student = new Student("S2", "Alice", "Martin", "alice@u-paris.fr", "2B");
    ...
    void testQuizMultipleQuestionsScore() {
        ...
        Student student = new Student("S3", "Bob", "Dupont", "bob@u-paris.fr", "2A");
